  - [HC]
    - The heatmap generated by the data parallel evaluator looks radically different for different deltat, and the evaluator breaks for larger delta value:
        ./data_parallel_evaluator --json ../data/fusion_science_use_case.json --max_deadline 300  --max_num_nodes 10 --lambda 0.01 --min_deadline 100 --step_deadline 10 --deltat XXX | python3 ../python/plot_data_parallel_heatmap.py
