#ifndef SCHEDULINGALGORITHMGREEDYNEARSIGHTEDDECREMENTING_H
#define SCHEDULINGALGORITHMGREEDYNEARSIGHTEDDECREMENTING_H
...
namespace wrench {
     ...
     */
    class SchedulingAlgorithmGreedyNearsightedDecrementing : public SchedulingAlgorithmGreedyNearsighted {
    public:
        SchedulingAlgorithmGreedyNearsightedDecrementing(
            ...
            : SchedulingAlgorithmGreedyNearsighted(application_specs, "greedy_nearsighted_decrementing", exec_options,
