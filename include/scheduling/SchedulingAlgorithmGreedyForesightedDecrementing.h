#ifndef SCHEDULINGALGORITHMGREEDYFORESIGHTEDDECREMENTING_H
#define SCHEDULINGALGORITHMGREEDYFORESIGHTEDDECREMENTING_H
...
namespace wrench {
     ...
     */
    class SchedulingAlgorithmGreedyForesightedDecrementing : public SchedulingAlgorithmGreedyForesighted {
    public:
        SchedulingAlgorithmGreedyForesightedDecrementing(
            ...
            : SchedulingAlgorithmGreedyForesighted(application_specs, "greedy_foresighted_decrementing", exec_options,
