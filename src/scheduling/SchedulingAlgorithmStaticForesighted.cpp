...
namespace wrench {
    void SchedulingAlgorithmStaticForesighted::preprocess_host_decisions(
        ...
        std::cerr << "current_decision_node_option = " << current_decision_node->execution_option << std::endl;
    ...
    double SchedulingAlgorithmStaticForesighted::calculate_prob_success_one_host(
        int remaining_tasks,
        int task_index,
